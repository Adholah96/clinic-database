...
**[vetclinic-database]** is a project that utilizes postgres sql to create a schema based on a diagrm.
...
- **[create many to many reletionships using a join table]**
...
Feel free to check the [issues page](https://github.com/Adholah96/clinic-database/issues).
